...
export function OnboardingFinal({ animationProgress }: OnboardingFinalProps) {
	...
	const finalRef = useRef<RNText | null>(null);
	...
	return (
		<Animated.View style={[containerStyle, slideAnimatedStyle]}>
			<View
				...
				accessibilityLabel={t("final.accessibility.image")}
			>
				<Animated.Image
					style={[imageStyle, imageAnimatedStyle]}
					source={AppImages.onboarding_final}
				/>
			</View>
			<Animated.View style={titleAnimatedStyle}>
				<Text
					...
					accessibilityLabel={t("final.accessibility.title")}
				>
					{t("final.title")}
				</Text>
			</Animated.View>
			<Text
				...
				accessibilityLabel={t("final.accessibility.subtitle")}
			>
				{t("final.subtitle")}
			</Text>
		</Animated.View>

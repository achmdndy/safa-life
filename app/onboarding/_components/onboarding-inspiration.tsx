...
export function OnboardingInspiration({
	...
	const inspirationRef = useRef<RNText | null>(null);
	...
	return (
		<Animated.View style={[containerStyle, slideAnimatedStyle]}>
			<Animated.View style={titleAnimatedStyle}>
				<Text
					...
					accessibilityLabel={t("inspiration.accessibility.title")}
				>
					{t("inspiration.title")}
				</Text>
			</Animated.View>
			<Animated.View style={subtitleAnimatedStyle}>
				<Text
					...
					accessibilityLabel={t("inspiration.accessibility.subtitle")}
				>
			...
			<View
				...
				accessibilityLabel={t("inspiration.accessibility.image")}
			>
				<Animated.Image
					style={[imageStyle, imageAnimatedStyle]}
					source={AppImages.onboarding_inspiration}
				/>
			</View>
		</Animated.View>
	);

...
import {
	PROFILE_HEADER_MAX_HEIGHT,
	PROFILE_HEADER_MIN_HEIGHT,
		...
		>
			...
			>
				<Avatar alt="User Image" className="w-28 h-28 border-4 border-gray-100">
					<AvatarImage
						source={{
							uri: "https://images.unsplash.com/photo-1651862224352-47dffe59ed79?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTd8fG11c2xpbSUyMGF2YXRhcnxlbnwwfHwwfHx8MA%3D%3D",
						}}
